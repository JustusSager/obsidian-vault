...
- Erstellung eines Plans für den kommenden Sprint ([[#Sprint Backlog]])
...
- Sicherstellen, dass die [[#Events|Scrum Events]] ordnungsgemäß durchgeführt werden.
...
1. Sprint Goal
	- Das Sprint Goal wird während des [[#Sprint Planning]] festgelegt.
...
2. Aufgaben
	- Es werden Aufgaben aus dem [[#Produkt Backlog]] ausgewählt welche innerhalb des Sprints abgearbeitet werden sollen.
	- Diese Aufgaben können jedoch im laufe des Sprints noch angepasst und in ihrer Umsetzung verändert werden.
3. Die Ergebnisse der [[#Sprint Retrospective]], festgehalten für künftige Sprints.
...
- Beispiele für das Erfüllen der gestellten Anforderungen sind
...
2. Was kann in diesem Sprint umgesetzt werden?
   In Diskussion mit dem Product Owner, wählen die Developer die zu entwickelnden Punkte aus dem [[#Product Backlog]] aus, welche in diesem Sprint umgesetzt werden sollen.
3. Wie werden die ausgewählten Punkte umgesetzt?
   Die Developer entwickeln für jeden ausgewählten Punkt einen Plan, wie dadurch ein [[#Increment]] entsteht, welches der "Definition of Done" entspricht.

Das Sprint Goal, die aus dem [[#Product Backlog]] gewählten Punkte und der Plan der Umsetzung dieser Punkte werden als [[#Sprint Backlog]] zusammengefasst.
...
- [[#Product Backlog]] kann hier mit neuen Ideen angepasst werden.
...
- Änderungen sollten auch im [[#Sprint Backlog]] festgehalten werden.
